  ...
  test "should create rating" do
    ...
    test "should create comment" do
      ...
      assert_difference('Comment.count') do
        post :create_comment, medic_id: @medic.id, content: "Voce nao pode me prender por que eu sou ricaaa!", 
        comment: {date: Time.now, medic: @medic, user: @user, comment_status: true, report: false}
      end 
